The following python codes are for ALX 0x03-Unittests_and_integration_tests project within the alx-backend-python curriculum, inside it contains the following python codes:
